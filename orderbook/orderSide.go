...
// NewOrderSide creates a new OrderSide manager
func NewOrderSide() *OrderSide {
	return &OrderSide{
		priceTree: rbt.NewWith(rbtComparator),
		prices:    map[string]*OrderQueue{},
		volume:    decimal.Zero,
	}
}
...
// Volume returns total amount of InitialQuantity in side
...
func (os *OrderSide) Append(o *Order) *list.Element {
	...
	os.numOrders++
	os.volume = os.volume.Add(o.InitialQuantity())
...
func (os *OrderSide) Remove(e *list.Element) *Order {
	...
	os.numOrders--
	os.volume = os.volume.Sub(o.InitialQuantity())
	return o
}
...
func (os *OrderSide) UnmarshalJSON(data []byte) error {
	...
	os.priceTree = rbt.NewWith(rbtComparator)
